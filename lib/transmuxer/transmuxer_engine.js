...
shaka.transmuxer.TransmuxerEngine = class {
  ...
  /**
   * Pass Player configuration to TransmuxerEngine.
   * @param {?shaka.extern.PlayerConfiguration} config
   */
  static setPlayerConfig(config) {
    const TransmuxerEngine = shaka.transmuxer.TransmuxerEngine;
    TransmuxerEngine.playerConfig = config;
  }
};
...
/** @public {?shaka.extern.PlayerConfiguration} */
shaka.transmuxer.TransmuxerEngine.playerConfig = null;
